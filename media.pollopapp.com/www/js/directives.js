...
app.directive("pollList", function() {

  return {
  
    restrict: "E",
    templateUrl: "html/" + target + "/pages/poll-list.html"
  
  };

});

app.directive("pollText", function() {

  return {
  
    restrict: "E",
    templateUrl: "html/" + target + "/pages/poll-text.html"
  
  };

});

app.directive("pollImage", function() {

  return {
  
    restrict: "E",
    templateUrl: "html/" + target + "/pages/poll-image.html"
  
  };

});

app.directive("pollCompact", function() {

  return {
  
    restrict: "E",
    templateUrl: "html/" + target + "/pages/poll-compact.html"
  
  };

});

app.directive("pollResults", function() {

  return {
  
    restrict: "E",
    templateUrl: "html/" + target + "/pages/poll-results.html"
